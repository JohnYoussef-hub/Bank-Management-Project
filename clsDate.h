...
public:
	...
	static string GetSystemDateTime()
	{
		...
		string LogLine = "";
        LogLine += Date.DateToString() + " - ";
        LogLine += to_string(Date.GetSystemHours()) + ':' + to_string(Date.GetSystemMinutes()) + ':' + to_string(Date.GetSystemSeconds());
